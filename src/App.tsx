...
function App() {
  ...
  const beforeFirstSection = scrollSpyIndex === -1;
  const hintIndex = useAttentionCycle(beforeFirstSection, RAIL_SECTION_IDS.length);
  const activeIndex = beforeFirstSection ? hintIndex : scrollSpyIndex;
